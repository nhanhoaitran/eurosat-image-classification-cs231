...
### 4. Hướng dẫn chạy Web Demo

Vì file trọng số của mô hình vượt quá giới hạn dung lượng của GitHub, vui lòng làm theo các bước sau để chạy Web Demo:
1. Tải file trọng số `ConvNeXt_EuroSAT_Best.pth` tại đây: https://drive.google.com/file/d/1eyADQ8CJFYmakGJ6a6xYnP1vNGfYAuLr/view?usp=sharing
2. Đặt file vừa tải về vào cùng thư mục `Web Demo` (chung với file `app.py`).
3. Cài đặt các thư viện cần thiết và chạy lệnh: `streamlit run app.py`
